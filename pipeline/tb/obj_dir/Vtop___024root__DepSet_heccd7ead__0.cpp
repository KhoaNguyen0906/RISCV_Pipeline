...
VL_INLINE_OPT void Vtop___024root___sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if ((8U == (IData)(vlSelf->top__DOT__design1__DOT__op_o2))) {
        if ((0U == (IData)(vlSelf->top__DOT__design1__DOT__imm_sto_out2))) {
            vlSelf->top__DOT__design1__DOT__rs2_data 
                = (((- (IData)((vlSelf->top__DOT__design1__DOT__data2_3 
                                >> 0x1fU))) << 8U) 
                   | (0xffU & vlSelf->top__DOT__design1__DOT__data2_3));
        } else if ((1U == (IData)(vlSelf->top__DOT__design1__DOT__imm_sto_out2))) {
            vlSelf->top__DOT__design1__DOT__rs2_data 
                = (((- (IData)((vlSelf->top__DOT__design1__DOT__data2_3 
                                >> 0x1fU))) << 0x10U) 
                   | (0xffffU & vlSelf->top__DOT__design1__DOT__data2_3));
        } else if ((2U == (IData)(vlSelf->top__DOT__design1__DOT__imm_sto_out2))) {
            vlSelf->top__DOT__design1__DOT__rs2_data 
                = vlSelf->top__DOT__design1__DOT__data2_3;
        }
    } else {
        vlSelf->top__DOT__design1__DOT__rs2_data = vlSelf->top__DOT__design1__DOT__data2_3;
    }
    if (vlSelf->rst_ni) {
    ...
    vlSelf->top__DOT__design1__DOT__pc_ins = (0x1fffU 
